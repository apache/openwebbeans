...
public final class WebBeansUtil
{
	 ...
	 * 
	 * @param clazz
	 *            web beans simple class
	 * @throws WebBeansConfigurationException
	 *             if the web beans has incompatible constructor
	 */
	 ...
	 * @param clazz
	 *            checked class
	 * @param commonAnnotation
	 *            post construct or predestroy annotation
	 ...
	 * @param annotation
	 *            annotation type
	 * @param definedInInterceptorClass
	 *            check if annotation is defined in interceptor class
	 * @param definedInMethod
	 *            check if the interceptor is defined in the comp. method
	 * @param stack
	 *            interceptor stack
	 * @param annotatedInterceptorClassMethod
	 *            if definedInMethod, this specify method
	...
	public static void checkInjectedMethodParameterConditions(Method method, Class<?> clazz)
	{
		...
		{
			throw new WebBeansConfigurationException("Initializer method parameters in method : " + method.getName() + " in class : " + clazz.getName() + 
				" can not be annotated with @Disposes or @Observers");
