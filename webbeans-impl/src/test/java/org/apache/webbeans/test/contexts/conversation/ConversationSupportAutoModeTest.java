...
/**
 * OWB-1074: conversation support follows deployment (no configuration property).
 */
public class ConversationSupportAutoModeTest extends AbstractUnitTest
{
    ...
    public void autoModeWithoutConversationScopedBeanDisablesSupport()
    {
        ...
        Assert.assertFalse(((AbstractContextsService) cs).isSupportsConversation());
    }
    ...
    public void autoModeWithConversationScopedBeanEnablesSupport()
    {
        ...
        ContextsService cs = getWebBeansContext().getContextsService();
        Assert.assertTrue(cs instanceof AbstractContextsService);
        Assert.assertTrue(((AbstractContextsService) cs).isSupportsConversation());
    }
    ...
    @ConversationScoped
    public static class PassivationCapableConversationBean implements Serializable
    {
