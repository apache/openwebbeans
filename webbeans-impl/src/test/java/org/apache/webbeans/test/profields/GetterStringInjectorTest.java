...
public class GetterStringInjectorTest extends AbstractUnitTest
{
    ...
    public void testGetterStringInjector()
    {
        ...
        Bean<GetterStringFieldInjector> bean = (Bean<GetterStringFieldInjector>) getBeanManager().getBeans("org.apache.webbeans.test.profields.beans.GetterStringFieldInjector").iterator().next();
