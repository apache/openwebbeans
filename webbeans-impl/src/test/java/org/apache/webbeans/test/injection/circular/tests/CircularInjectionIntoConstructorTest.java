...
public class CircularInjectionIntoConstructorTest extends AbstractUnitTest
{
    ...
    public void testOneNormalOneDependent()
    {
        ...
        Set<Bean<?>> beans = getBeanManager().getBeans("org.apache.webbeans.test.injection.circular.beans.CircularNormalInConstructor");
        ...
        beans = getBeanManager().getBeans("org.apache.webbeans.test.injection.circular.beans.CircularConstructorOrProducerMethodParameterBean");
        Assert.assertNotNull(beans);        
