...
[![Build Status ASF](https://ci-builds.apache.org/buildStatus/icon?subject=ASF-Build&job=OpenWebBeans%2FOpenWebBeans CI (main))](https://ci-builds.apache.org/job/OpenWebBeans/job/OpenWebBeans CI (main)/)
